...
function open2(){
    window.location = "http://localhost:2013/dataleakage/filelock.jsp"
}
function open3(){
    window.location = "http://localhost:2013/dataleakage/fileunlock.jsp"
}
...
%>
  <div id="wrapper"> 
    ...
    <ul id="menu" class="cleaning-box">
      ...
      <li><a href="agentfile.jsp" class="active">User Files</a></li>
