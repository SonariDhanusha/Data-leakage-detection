      ...
      <div id="content-box-in"> 
        ...
        <div class="content-box-left"> 
          <div class="content-box-left-in"> 
            ...
            <form name="form"  action="edituser1.jsp" onSubmit="return valid();" method="post"  >
              <table>
                <tr> 
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr> 
                  ...
                  <td>:</td>
                  <td><font size="2">
                  <input type="text" name="uname" value="<%=uname%>" readonly="readonly"> 
                ...
                <tr> 
                  <td></td>
                  <td><input style="background: url('../img/submit.jpeg')" type="submit" name="edit" value="Save" >&nbsp;<input style="background: url('../img/submit.jpeg')" type="reset" name="edit" value="Clear" ></td>
                  <td></td>
                </tr>
              </table>
              </form>
