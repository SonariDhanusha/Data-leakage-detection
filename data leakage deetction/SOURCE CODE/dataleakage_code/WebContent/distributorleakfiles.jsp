 ...
 Connection con=null;
  ...
  <div id="wrapper"> 
    ...
    <ul id="menu" class="cleaning-box">
      ...
      <li><a href="distributorleakfiles.jsp"  class="active">Leak Files</a></li>
          ...
          <div align="center" class="content-box-left-in"> 
            ...
            <div align="center" style="background-color: #FFF2EF"> 
              <table border="1" width="500" height="" cellpadding="5" cellspacing="5">
                <tr>&nbsp;</tr>
                <tr>                   
                  <td  height="" class="paragraping"><font color="#FF0000"><strong>From</strong></font></td>
                  ...
                  <td  class="paragraping"><font color="#FF0000"> <strong>To </strong></font></td>
				  </tr>
				  <%
				  while(rs.next())
				  {
                  ...
                  <td  class="paragraping"><font size="2"><%= rs1.getString(1)%></font></td>
				  </tr>
