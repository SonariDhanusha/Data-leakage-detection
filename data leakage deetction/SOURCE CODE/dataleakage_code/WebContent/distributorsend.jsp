 ...
 Connection con=null;
  ...
  <div id="wrapper"> 
    ...
    <ul id="menu" class="cleaning-box">
      ...
      <li><a href="distributorsend.jsp" class="active">Send Files</a></li>
          ...
          <div align="center" class="content-box-left-in"> 
            ...
            <div align="center" style="background-color: #FFF2EF"> 
              <table>
                ...
                <tr> 
                  <td></td>
                  <td><input style="background: url('../img/submit.jpeg')" type="submit" name="send" value="Send" ></td>
              ...
              {
            	  %>
            	  <h3 i style="color: green">File sent successfully.....</h3>
            	  <%
              }
