...
function open2(){
    window.location = "http://localhost:8080/dataleakage_code/filelock.jsp"
}
function open3(){
    window.location = "http://localhost:8080/dataleakage_code/fileunlock.jsp"
}
...
String filename=null,subject=null,date=null,mod=null,key=null;
            ...
            <div align="center" style="background-color: #FFF2EF"> 
              <table border="1" width="500" height="" cellpadding="5" cellspacing="5">
                ...
                <tr> 
                 ...
                 <tr> 
                  <td  height="" class="paragraping"><font color="#FF0000">Key</font></td>
                  <td>:</td>
                  <td ><font size="2"> 
                    <%=key%>
                    </font></td>
                ...
                <tr>&nbsp;</tr>
                <tr> 
                  <td ><font color="#FF0000" size="+2"><img src="img/download.jpg" width="63" height="47" /></font><a href="keyenter.jsp?msg=<%=filename%>">Download</a></td>
